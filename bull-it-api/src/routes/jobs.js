...
const getJobsRouter = (deps) => {
    ...
    jobsRouter.get('/fetch',async(req,res,next) => {
        ...
        try {
            ...
            const queryObj = jobsQueryBuilder().addJobId(queryParams._id || null).addSchedulingStrategies(queryParams.schedulingStrategies ? queryParams.schedulingStrategies.split(',') : null).build();
